...
class _SearchMapScreenState extends State<SearchMapScreen>with TickerProviderStateMixin {
  ...
  final LatLng markerPosition = LatLng(51.5001, -0.0900);
  final LatLng markerPosition2 = LatLng(51.5100, -0.0900);
                        ...
                        child: MarkerLayer(
                          markers: [
                            locationTag(
                                ...
                                height: 50.h,
                                icon: Icons.apartment_outlined, txt: 'Location 1',
                              isText: isText,
                            ),
                            locationTag(
                              point: markerPosition2,
                              onTap: (){},
                              width: isText?_widthTag.value.w:_widthTag.value.w/2,
                              height: 50.h,
